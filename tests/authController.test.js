...
describe('Auth Controller', () => {
  ...
  describe('Register', () => {
    ...
    it('should not register a user with an existing email or username', async () => {
      ...
      expect(res.body).toHaveProperty('message', 'User already exists with that email or username');
    });
  });
  ...
  describe('UpdateDetails', () => {
    it('should update user details', async () => {
      ...
      expect(res.body.data).toHaveProperty('email', 'updatedtestuser5@example.com');
    });
